...
set-face global DiagnosticError       ",,%opt{bright_red}+c"
# set-face global InfoDiagnosticError       "%opt{yellow},%opt{background}"
# set-face global InfoDiagnosticHint        "%opt{yellow},%opt{background}"
# set-face global InfoDiagnosticInformation "%opt{yellow},%opt{background}"
# set-face global InfoDiagnosticWarning     "%opt{yellow},%opt{background}"
