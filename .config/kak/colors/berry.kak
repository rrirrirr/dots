...
red global class+b%opt{yellow}"
# red global self +bopt{yellow}"
red global const+bt "%opt{amber}+b"
red global brack+b "%opt{white}+b"
...
set-face global Error "%opt{yellow},%opt{black}+c"
...
set-face global InfoDiagnosticError       "%opt{yellow},%opt{black}"
set-face global InfoDiagnosticHint        "%opt{yellow},%opt{black}"
set-face global InfoDiagnosticInformation "%opt{yellow},%opt{black}"
set-face global InfoDiagnosticWarning     "%opt{yellow},%opt{black}"
